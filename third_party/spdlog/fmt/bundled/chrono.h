  ...
  public:
        ...
        -> decltype(ctx.begin())
    {
        ...
        begin = internal::parse_width(begin, end, handler);
            ...
            parse_chrono_format(begin, end, internal::chrono_format_checker());
    ...
    auto format(const duration &d, FormatContext &ctx) -> decltype(ctx.out())
    {
        ...
        if (begin == end || *begin == '}') {
            ...
            internal::chrono_formatter<FormatContext, decltype(out)> f(ctx,
                                                                       out);
            f.s = std::chrono::duration_cast<std::chrono::seconds>(d);
            f.ms =
                std::chrono::duration_cast<std::chrono::milliseconds>(d - f.s);

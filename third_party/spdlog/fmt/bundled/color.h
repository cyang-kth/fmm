...
{
    return ansi_color_escape<Char>(foreground,
...
{
    return ansi_color_escape<Char>(background,
            ...
            basic_format_args<typename buffer_context<Char>::type> args)
{
    ...
    if (ts.has_emphasis()) {
        has_style = true;
        internal::fputs<Char>(internal::make_emphasis<Char>(ts.get_emphasis()),
                              f);
    }
...
template <typename String, typename... Args>
typename std::enable_if<internal::is_string<String>::value>::type
print(const text_style &ts, const String &format_str, const Args &...args)
{

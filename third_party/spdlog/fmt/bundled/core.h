...
#else
template <typename... T> struct is_constructible : std::is_constructible<T...>
{
};
#endif
...
template <typename OutputIt, typename Context, typename Char> class context_base
{
  public:
...
class basic_format_context
    : public internal::context_base<OutputIt,
                                    basic_format_context<OutputIt, Char>, Char>
{
  public:

...
struct OutputConfig
{
    ...
    bool write_error = false;  /**< if true, gps error (distance from GPS point
                                  to  the matched point) will be exported */
    ...
    bool write_tp = false; /**< if true, tp (transition probability) will be
                                exported */
    bool write_length = false;   /**< if true, length (length of each matched
                                    edge)   will be exported */

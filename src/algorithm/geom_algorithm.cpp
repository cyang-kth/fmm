...
FMM::ALGORITHM::split_line(const FMM::CORE::LineString &line, double delta)
{
...
FMM::CORE::LineString
FMM::ALGORITHM::interpolate_line_distances(const FMM::CORE::LineString &line,
...
FMM::CORE::LineString
FMM::ALGORITHM::interpolate_line_distance(const FMM::CORE::LineString &line,
                                          double distance)
{
...
FMM::CORE::LineString
FMM::ALGORITHM::interpolate_line_kpoints(const FMM::CORE::LineString &line,
                                         int k)
{
    double length = line.get_length();
    std::vector<double> distances;
...
void FMM::ALGORITHM::boundingbox_geometry(
    const FMM::CORE::LineString &linestring, double *x1, double *y1, double *x2,
    double *y2)
{
...
std::vector<double>
FMM::ALGORITHM::calc_length_to_end_vec(const FMM::CORE::LineString &geom)
{
...
void FMM::ALGORITHM::closest_point_on_segment(double x, double y, double x1,
...
void FMM::ALGORITHM::linear_referencing(double px, double py,
                                        const FMM::CORE::LineString &linestring,
                                        double *result_dist,
                                        double *result_offset, double *proj_x,
                                        double *proj_y)
{
    int Npoints = linestring.get_num_points();
    double min_dist = DBL_MAX;
...
void FMM::ALGORITHM::locate_point_by_offset(
    const FMM::CORE::LineString &linestring, double offset, double *x,
    double *y)
{
    int Npoints = linestring.get_num_points();
    if (offset <= 0.0) {
...
FMM::CORE::LineString
FMM::ALGORITHM::cutoffseg_unique(const FMM::CORE::LineString &linestring,
...
FMM::CORE::LineString
FMM::ALGORITHM::cutoffseg(const FMM::CORE::LineString &linestring,

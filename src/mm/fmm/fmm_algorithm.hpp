...
class FastMapMatch
{
  ...
  protected:
     ...
     */
    void update_tg(TransitionGraph *tg, const CORE::Trajectory &traj,
     ...
     * @param connected the variable is set to false if the layer is not
     * connected with the next layer
     */

...
bool UBODTGenAppConfig::validate() const
{
    ...
    if (log_level < 0 || log_level > UTIL::LOG_LEVESLS.size()) {
        SPDLOG_CRITICAL("Invalid log_level {}, which should be 0 - 6",
                        log_level);

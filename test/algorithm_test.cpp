...
TEST_CASE("Algorithm are tested", "[algorithm]")
{
    ...
    SECTION("cutoffseg_unique")
    {
        ...
        LineString expected_2 =
            wkt2linestring("LineString(0 0,0 1,0 2,1 1,1.1 1)");
        REQUIRE(expected_2 == result_2);
        // Two midpoints
        LineString result_3 =
            cutoffseg_unique(line, 2 + sqrt(2) / 2, 2.5 + sqrt(2));
        LineString expected_3 = wkt2linestring("LineString(0.5 1.5,1 1,1.5 1)");
        REQUIRE(expected_3 == result_3);

        // One midpoint to vertex
        LineString result_4 =
            cutoffseg_unique(line, 2 + sqrt(2) / 2, 3 + sqrt(2));
        LineString expected_4 = wkt2linestring("LineString(0.5 1.5,1 1,2 1)");
        REQUIRE(expected_4 == result_4);

        // One midpoint to end
        LineString result_5 =
            cutoffseg_unique(line, 2 + sqrt(2) / 2, 4 + sqrt(2));
        LineString expected_5 =
            wkt2linestring("LineString(0.5 1.5,1 1,2 1,2 0)");
    ...
    SECTION("cutoffseg")
    {
        ...
        LineString expected_1 =
            wkt2linestring("LineString(0 0,0 1,0 2,1 1,2 1,2 0)");
        REQUIRE(expected_1 == result_1);
        // From start
        LineString result_2 = cutoffseg(line, 1, mode);
        LineString expected_2 =
            wkt2linestring("LineString(0 1,0 2,1 1,2 1,2 0)");
        REQUIRE(expected_2 == result_2);
        // From a midpoint
        LineString result_3 = cutoffseg(line, 0.5, mode);
        LineString expected_3 =
            wkt2linestring("LineString(0 0.5,0 1,0 2,1 1,2 1,2 0)");
        REQUIRE(expected_3 == result_3);
        ...
        LineString expected_5 =
            wkt2linestring("LineString(0 0,0 1,0 2,1 1,2 1)");
        REQUIRE(expected_5 == result_5);

        // Test for a  midpoint
        LineString result_6 = cutoffseg(line, line.get_length() - 0.5, mode);
        LineString expected_6 =
            wkt2linestring("LineString(0 0,0 1,0 2,1 1,2 1,2 0.5)");
